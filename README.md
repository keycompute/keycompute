# KeyCompute for "ALL In Token"

KeyCompute 是一个高性能，易拓展，开箱即用的 AI Token 算力服务平台，提供统一的大模型接入、智能路由、计费和可观测性等服务。

支持多种类型的 AI 算力池聚合，包括不限于自建算力，公共厂商，OAuth 代理等。

KeyCompute 是一个完全开源的项目，采用最宽松的 MIT 许可证。
